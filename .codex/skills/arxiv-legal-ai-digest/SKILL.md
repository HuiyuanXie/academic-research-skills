...
config/topics.yaml
scripts/arxiv_legal_ai_digest.py
state/last_run.json
...
requirements.txt
.env
.codex/skills/arxiv-legal-ai-digest/SKILL.md

## Workflow
1. Run scripts/arxiv_legal_ai_digest.py; if dependencies are missing, prompt to install from requirements.txt
